        ...
        <div class="container">
            <div class="row">
                        ...
                        <div style="--swiper-navigation-color: #fff; --swiper-pagination-color: #fff"
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <a href="https://youtu.be/pNIOIHnI_-s" data-fancybox="gallery">
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <a href="https://swiperjs.com/demos/images/nature-2.jpg" data-fancybox="gallery">
                                        <img src="https://swiperjs.com/demos/images/nature-2.jpg" />
                                    </a>
                                </div>
                                <div class="swiper-slide">
                                    <a href="https://swiperjs.com/demos/images/nature-3.jpg" data-fancybox="gallery">
                                        <img src="https://swiperjs.com/demos/images/nature-3.jpg" />
                                    </a>
                                </div>
                                <div class="swiper-slide">
                                    <a href="https://swiperjs.com/demos/images/nature-4.jpg" data-fancybox="gallery">
                                        <img src="https://swiperjs.com/demos/images/nature-4.jpg" />
                                    </a>
                                </div>
                                <div class="swiper-slide">
                                    <a href="https://swiperjs.com/demos/images/nature-5.jpg" data-fancybox="gallery">
                                        <img src="https://swiperjs.com/demos/images/nature-5.jpg" />
                                    </a>
                                </div>
                                <div class="swiper-slide">
                                    <a href="https://swiperjs.com/demos/images/nature-6.jpg" data-fancybox="gallery">
                                        <img src="https://swiperjs.com/demos/images/nature-6.jpg" />
                                    </a>
                                </div>
                                <div class="swiper-slide">
                                    <a href="https://swiperjs.com/demos/images/nature-7.jpg" data-fancybox="gallery">
                                        <img src="https://swiperjs.com/demos/images/nature-7.jpg" />
                                    </a>
                                </div>
                                <div class="swiper-slide">
                                    <a href="https://swiperjs.com/demos/images/nature-8.jpg" data-fancybox="gallery">
                                        <img src="https://swiperjs.com/demos/images/nature-8.jpg" />
                                    </a>
                                </div>
                                <div class="swiper-slide">
                                    <a href="https://swiperjs.com/demos/images/nature-9.jpg" data-fancybox="gallery">
                                        <img src="https://swiperjs.com/demos/images/nature-9.jpg" />
                                    </a>
                                </div>
                                <div class="swiper-slide">
                                    <a href="https://swiperjs.com/demos/images/nature-10.jpg" data-fancybox="gallery">
                ...
                <div class="col-lg-6 right details">
                    ...
                    <h1 class="title text-primary-color fw-bolder">Flower Silk 3 Piece Dress</h1>
                    <h3>Category: <span class="text-primary-color">Top Seles</span></h3>
                    <ul>
                        <li>ড্রেস ফেব্রিক্স - ইমপোর্টেড কাশ্মীরি সিল্ক </li>
                        <li>দুপাট্টা - ইমপোর্টেড কাশ্মীরি সিল্ক</li>
                        <li>সালোয়ার - সফ্ট কটন </li>
                        <li>ড্রেস লং - ৪৬" </li>
                        <li>ড্রেস বডি - আনস্টিচড আপটু ৫২ , আপনার প্রেফারেবল সাইজে অল্টার করে নিতে হবে</li>
                    </ul>
                    <div class="row price-details align-items-center justify-content-between">
                        <div class="col-lg-6 Price text-start">
                            ...
                            <span class="discount-price fs-3 fw-bold ">৳ 1950.00</span>
                        </div>
                        <div class="col-lg-6">
                    ...
                    <div class="order-form-box">
                        ...
                        <form id="order-form" action="">
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        <label for="exampleFormControlInput1" class="form-label fw-bold fs-5">নাম</label>
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        <label for="exampleFormControlInput1" class="form-label fw-bold fs-5">ফোন
                                            <sub>(11 সংখ্যা
                                                হতে
                                                হবে)</sub></label>
                                        <input type="text" class="form-control" id="exampleFormControlInput1"
                                            placeholder="phone (Must be 11 Digits)">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="mb-3">
                                        <label for="exampleFormControlTextarea1" class="form-label fw-bold fs-5">ডেলিভারি
                                            ঠিকানা</label>
                                        <textarea class="form-control" id="exampleFormControlTextarea1" placeholder="Delivery Address" rows="3"></textarea>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" aria-label="Default select example">
                                            ...
                                            <option value="1">ডেলিভারি চার্জ ঢাকার ভিতরে - 80TK</option>
                                            <option value="2">ডেলিভারি চার্জ ঢাকার বাইরে - 150Tk</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-6">
                                ...
                                <div class="col-6">
                                    <div class="mb-3">
                                        <label for="exampleFormControlTextarea1" class="form-label ">পরিমাণ</label>
                                        <input class="form-control fw-bold fs-5" type="text" value="1950"
