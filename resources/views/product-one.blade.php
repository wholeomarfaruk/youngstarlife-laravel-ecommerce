        ...
        <div class="container">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb fs-5">
                    <li class="breadcrumb-item"><a href="https://seldomfashion.com" class="text-dark " style="text-decoration: none">Home</a></li>
            ...
            <div class="row">
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <a href="https://youtu.be/pNIOIHnI_-s" data-fancybox="gallery">
                                        <img loading="lazy"   src="{{asset('image/product/IMG_5481.webp')}}" />
                                        <span class="play-button"><i class="fa-solid fa-circle-play"></i></span>
                                    </a>
                                </div>
                                <div class="swiper-slide">

                                    <a href="{{asset('image/product/IMG_5482.webp')}}" data-fancybox="gallery">
                                        <img loading="lazy"  src="{{asset('image/product/IMG_5482.webp')}}" />
                                    </a>
                                </div>
                                <div class="swiper-slide">
                                    <a href="{{asset('image/product/IMG_5484.webp')}}" data-fancybox="gallery">
                                        <img loading="lazy"  src="{{asset('image/product/IMG_5484.webp')}}" />
                                    </a>
                                </div>
                                <div class="swiper-slide">
                                    <a href="{{asset('image/product/IMG_5485.webp')}}" data-fancybox="gallery">
                                        <img loading="lazy"  src="{{asset('image/product/IMG_5485.webp')}}" />
                                    </a>
                                </div>
                                <div class="swiper-slide">
                                    <a href="{{asset('image/product/IMG_5486.webp')}}" data-fancybox="gallery">
                                        <img loading="lazy"  src="{{asset('image/product/IMG_5486.webp')}}" />
                                    </a>
                                </div>
                                <div class="swiper-slide">
                                    <a href="{{asset('image/product/IMG_5487.webp')}}" data-fancybox="gallery">
                                        <img loading="lazy"  src="{{asset('image/product/IMG_5487.webp')}}" />
                                    </a>
                                </div>
                                <div class="swiper-slide">
                                    <a href="{{asset('image/product/IMG_5488.webp')}}" data-fancybox="gallery">
                                        <img loading="lazy"  src="{{asset('image/product/IMG_5488.webp')}}" />
                                    </a>
                                </div>
                                <div class="swiper-slide">
                                    <a href="{{asset('image/product/IMG_5490.webp')}}" data-fancybox="gallery">
                                        <img loading="lazy"  src="{{asset('image/product/IMG_5490.webp')}}" />
                                    </a>
                                </div>
                                <div class="swiper-slide">
                                    <a href="{{asset('image/product/IMG_5491.webp')}}" data-fancybox="gallery">
                                        <img loading="lazy"  src="{{asset('image/product/IMG_5491.webp')}}" />
                                    </a>
                                </div>
                                <div class="swiper-slide">
                                    <a href="{{asset('image/product/IMG_5493.webp')}}" data-fancybox="gallery">
                                        <img loading="lazy"  src="{{asset('image/product/IMG_5493.webp')}}" />
                                    </a>
                                </div>
                            </div>
                ...
                <div class="col-lg-6 right details ">
                    ...
                    <div class="order-form-box">
                        <h4 class="fw-bold fs-3 mb-3">অর্ডার ফর্ম</h4>
...
<script>
 ...
 $(document).ready(function(){
    ...
    function calculateTotal() {
        ...
        let deliveryCharge = parseFloat($('select[name="delivery_area"] option:selected').data('charge')) || 0;
