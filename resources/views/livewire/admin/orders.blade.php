        ...
        <div class="main-content-wrap">
            ...
            <div class="wg-box">
                <div class="row ">
                    <div class="wg-filter col-md-6 mb-3">
                        <form class="form-search">
                            <fieldset class="name">
                                <input type="text" wire:model.live='search' placeholder="Search here..." class="" name="search"
                ...
                <div class=" row">
                    <div class="col-md-6 d-flex align-items-center gap-2">
                        <form id="bulk-action-form" action="" class="d-inline " style="width:fit-content;">
                            ...
                            <div class="flex items-center flex-wrap justify-start gap-2 ">
                                ...
                                <select wire:model.live='order_status' class="form-control btn-outline-success" style="width: inherit;" name="status"
                    ...
                    <div class="col-md-6">
                        <input type="text" wire:model.live='daterange' class="form-control rangedatepicker" name="daterange"
